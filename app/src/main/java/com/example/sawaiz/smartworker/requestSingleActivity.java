...
public class requestSingleActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    String userId, customerId, handymanId, name, latlng, lat, lng, date, time, timeuser, myTime,xTime,dur, notificationKey, duration, t, d,modifyTime;
    public static String gt, gd;

    private int hour, minute, reqcode, year, month, day, reqcode1;
    ...
    private ArrayList<String> arrDatelist = new ArrayList<String>();
    private ArrayList<String> arrTimelist = new ArrayList<String>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        jobduration = (TextView) findViewById(R.id.JobDuration_txt);
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data.put("Date", date);
                data.put("Time", time);
                data.put("JobTimeDuration", duration);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot child : dataSnapshot.getChildren()) {
                        ...
                        if (child.getKey().equals("JobTimeDuration")) {
                            duration = child.getValue().toString();
